...
model, writes tools/linorobot2_console/NAV2_COMMUNITY_ISSUES.md.

Run on a21 (or a20). Streams the model response so it can't wedge on one long
...
NODE = os.environ.get("NAV2_RESEARCH_NODE", "a21")
OUT_PATH = os.path.expanduser(
    "~/code/linorobot2/tools/linorobot2_console/NAV2_COMMUNITY_ISSUES.md"
)
